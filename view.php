...
$questions_page5 = [
    ...
    'd' => [
        ...
        'labels' => [
            ...
            'd3' => 'มีทิศทางแผนงานขยายการบูรณาการข้อมูลเชื่อมต่อโครงข่ายกลางของกระทรวงพาณิชย์และภาครัฐ',
            'd4' => 'หน่วยงานกำหนดให้ประเด็นด้านการจัดการและคุณภาพข้อมูลเป็นหนึ่งในตัวชี้วัดผลการทำงานหลักขององค์กร'
        ]
    ]
];
?>
