        ...
        <main class="document-paper">
            <form id="dqa-form" method="POST" action="api.php">
                ...
                <div id="step-2" class="form-step">
                        ...
                        <table class="assessment-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify font-medium">ข้อมูลมีแหล่งที่มาที่น่าเชื่อถือหรือไม่ (มีการระบุแหล่งที่มา สามารถตรวจสอบได้ว่ามาจากแหล่งใด แหล่งที่มาข้อมูลต้องได้รับรองจากหน่วยงาน/สถาบันที่น่าเชื่อถือ และมีการเผยแพร่หรือแลกเปลี่ยนเชื่อมโยงจากหน่วยงานที่มีการจดทะเบียนและมีตัวตนอยู่จริง)</td>
                                    <td class="text-center">
                                        <label class="table-radio">
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify font-medium">มีวิธีการ/เครื่องมือป้องกันรักษาความปลอดภัยของข้อมูลหรือไม่ (เช่น มีขั้นตอนหรือมาตรการป้องกันเพื่อลดความเสี่ยงอคติหรือข้อผิดพลาดในการบันทึกข้อมูล และมีการรักษาความปลอดภัยที่เหมาะสมเพื่อป้องกันการเปลี่ยนแปลงข้อมูลโดยที่ไม่ได้รับอนุญาต)</td>
                                    <td class="text-center">
                                        <label class="table-radio">
                    ...
                    <div class="dimension-desc-box">
                        ความทันเวลาต่อการใช้งานของข้อมูล ไม่ว่าจะเป็นการนําไปใช้ต่อในแง่การประมวลผลหรือการเผยแพร่ข้อมูล ความทันเวลาอ้างอิงจากความล่าช้าของข้อมูลซึ่งวัดได้หลายลักษณะขึ้นอยู่กับประเภทของข้อมูล เช่น วัดจากระยะเวลาที่ได้รับข้อมูลจนถึงเวลาที่ข้อมูลพร้อม ใช้งาน วัดจากระยะเวลาที่กําหนดของการเผยแพร่กับเวลาที่สามารถเผยแพร่ได้จริง
                    </div>
                        ...
                        <table class="assessment-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify font-medium">ข้อมูลที่จัดหาได้มีความถี่เพียงพอต่อการแจ้งแผนงานในการตัดสินใจบริหารจัดการหรือไม่</td>
                                    <td class="text-center">
                                        <label class="table-radio">
                        ...
                        <table class="assessment-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify font-medium">มีช่องทางการเผยแพร่ข้อมูลที่หลากหลายและสามารถเข้าถึงได้ง่ายหรือไม่ (มีระบบเทคโนโลยีสารสนเทศที่ทันสมัยและเหมาะสม และแพลตฟอร์มสื่อสังคมออนไลน์ต่าง ๆ ที่เป็นช่องทางในการเผยแพร่และสื่อสาร หรือ มีเว็บไซต์นำเสนอชุดข้อมูลตามมาตรฐานข้อมูลเปิด และมีการปรับปรุงสม่ำเสมอ)</td>
                                    <td class="text-center">
                                        <label class="table-radio">
                        ...
                        <div class="self-assess-card">
                            ...
                            <div class="self-assess-options">
                                <label class="self-assess-option">
                                    ...
                                    <span class="self-assess-option-text"><strong>1 ต่ำ :</strong> ขาดกระบวนการหรือเครื่องมือตรวจสอบ ความถูกต้องของข้อมูล</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_1_2" value="2">
                                    <span class="self-assess-option-text"><strong>2 ปานกลาง :</strong> มีกระบวนการตรวจสอบ จุดผิดพลาดที่ไร้รูปแบบ และอาศัยจากการคาดการณ์ อนุมาน โดยบุคคล</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_1_2" value="3">
                                    <span class="self-assess-option-text"><strong>3 ดี :</strong> มีกระบวนการ เครื่องมือตรวจสอบความถูกต้อง เป็นแบบแผน</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_1_2" value="4">
                                    <span class="self-assess-option-text"><strong>4 ดีมาก :</strong> มีกระบวนการ เครื่องมือตรวจสอบความถูกต้อง เป็นแบบแผน และแจ้งเตือนอัตโนมัติ</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="self-assess-card">
                            ...
                            <div class="self-assess-options">
                                <label class="self-assess-option">
                                    ...
                                    <span class="self-assess-option-text"><strong>1 ต่ำ :</strong> ขาดกระบวนการตรวจทาน ความครบถ้วนของข้อมูล</span>
                                </label>
                                <label class="self-assess-option">
                                ...
                                <label class="self-assess-option">
                                    ...
                                    <span class="self-assess-option-text"><strong>4 ดีมาก :</strong> มีกระบวนการรับรองว่าข้อมูล มีความครบถ้วน สมบูรณ์ตั้งแต่ขั้นตอนการเก็บรวบรวมจนถึงการจัดเก็บลงในระบบ</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="self-assess-card">
                            ...
                            <div class="self-assess-options">
                                <label class="self-assess-option">
                                    ...
                                    <span class="self-assess-option-text"><strong>1 ต่ำ :</strong> ขาดการกำหนดวิธีการเก็บข้อมูลด้วยกรอบ มาตรฐานที่น่าเชื่อถือ หรือลดความอคติ</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_1_4" value="2">
                                    <span class="self-assess-option-text"><strong>2 ปานกลาง :</strong> มีการกำหนดกลุ่มตัวอย่างการเก็บข้อมูล ตามหลักของสถิติ หรือ มีการใช้เครื่องมือพื้นฐาน</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_1_4" value="3">
                                    <span class="self-assess-option-text"><strong>3 ดี :</strong> อย่างใดอย่างหนึ่ง มีการควบคุมการเก็บรวบรวมจากกลุ่มตัวอย่างที่กำหนดตามหลักสถิติ เช่น เพศ ความเชื่อ ความชอบ เป็นต้น หรือ มีเครื่องมือการเก็บที่เป็นมาตรฐาน แบบสอบถามที่ทดสอบความเชื่อมั่น เที่ยงตรงตามหลักวิชาการแล้ว</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_1_4" value="4">
                                    <span class="self-assess-option-text"><strong>4 ดีมาก :</strong> มีการควบคุมการเก็บรวบรวมจากกลุ่มตัวอย่างที่กำหนดตาม หลักสถิติทุกประการ เช่น เพศ ความเชื่อ ความชอบ เป็นต้น และ มีเครื่องมือการเก็บที่เป็นมาตรฐาน แบบสอบถามที่ทดสอบความเชื่อมั่น เที่ยงตรงตามหลักวิชาการแล้ว</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="self-assess-card">
                            ...
                            <div class="self-assess-options">
                                ...
                                <label class="self-assess-option">
                                    ...
                                    <span class="self-assess-option-text"><strong>4 ดีมาก :</strong> มีคำนิยามของข้อมูลและมีมาตรฐานที่ชัดเจน รวมทั้ง ครอบคลุม กรณีผิดปกติให้ผู้เก็บข้อมูลสามารถเก็บข้อมูลได้ถูกต้อง</span>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="self-assess-card">
                            ...
                            <div class="self-assess-options">
                                <label class="self-assess-option">
                                    ...
                                    <span class="self-assess-option-text"><strong>1 ต่ำ :</strong> การเก็บข้อมูลในหน่วยงาน มีมาตรฐานการเก็บข้อมูลแตกต่างกัน และใช้งานข้อมูลร่วมกันไม่ได้</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_2_1" value="2">
                                    <span class="self-assess-option-text"><strong>2 ปานกลาง :</strong> การเก็บข้อมูลในหน่วยงาน อยู่ในรูปแบบที่แตกต่างกัน แต่สามารถอ้างอิง จัดชุดข้อมูลและใช้ร่วมกันได้</span>
                                </label>
                                <label class="self-assess-option">
                                    <input type="radio" name="sa_2_1" value="3">
                                    <span class="self-assess-option-text"><strong>3 ดี :</strong> การเก็บข้อมูลในหน่วยงาน อยู่ในรูปแบบที่แตกต่างกัน แต่สามารถอ้างอิงและใช้ร่วมกันได้</span>
                                </label>
                                <label class="self-assess-option">
                ...
                <div id="step-4" class="form-step">
                    <div class="paper-header">
                        ...
                        <div class="instruction-box" style="margin-top: 2rem; border-left: 4px solid var(--moc-gold); line-height: 1.45; font-size: 0.95rem; text-align: left; background-color: var(--moc-gold-light); color: var(--text-dark);">
                            ...
                            <ol style="margin-top: 0.5rem; padding-left: 1.25rem; display: flex; flex-direction: column; gap: 0.5rem;">
                                ...
                                <li>หัวหน้าแต่ละ กอง/สำนัก/ฝ่าย/ศูนย์ ควรจัดทำรายการตรวจสอบคุณภาพข้อมูลในขอบเขตงานที่รับผิดชอบให้แล้วเสร็จ โดยสามารถตรวจสอบตามแบบตรวจประเมินคุณภาพข้อมูลตาม Template</li>
                                <li>แบบตรวจประเมินนี้เป็นการรายงานผลสรุปของทีมผู้ประเมินคุณภาพโดยตรงสำหรับการจัดการเพื่อประกันความคุ้มค่าของการจัดสรรงบประมาณและเพื่อการตัดสินใจใช้ทรัพยากรข้อมูล มีวัตถุประสงค์เพื่อสนับสนุนการจัดเตรียมข้อมูลหลักฐานในขอบเขตของการจัดการคุณภาพข้อมูลสำหรับแจ้งให้รับทราบและใช้งานกันทั่วทั้งหน่วยงาน</li>
                                <li>แบบตรวจประเมินนี้ได้จัดทำจากข้อมูลกระบวนการจัดการคุณภาพ/กลยุทธ์ด้านคุณภาพข้อมูลขององค์กรเพื่อกำหนดเป็นมาตรฐาน โดยประเมินระดับความสำเร็จเปรียบเทียบแต่ละรายการตรวจประเมินคุณภาพข้อมูล โดยให้เลือกคำตอบ 1 ใน 3 ตัวเลือก ได้แก่ "มีอย่างเหมาะสม" "มีบางส่วน" และ "ไม่มี" ซึ่งแต่ละตัวเลือกจะเชื่อมโยงกับระดับความเสี่ยง ได้แก่ "ความเสี่ยงต่่ำ" "ความเสี่ยงปานกลาง" และ "ความเสี่ยงสูง" ซึ่งแบบตรวจประเมินนี้จะให้ความสำคัญกับกระบวนการที่มีความเสี่ยงปานกลาง หรือความเสี่ยงสูงที่ต้องได้รับการจัดการ/ลดความเสี่ยง</li>
                                <li>การตรวจประเมินนี้ควรมีหลักฐานแนบในคอลัมน์สุดท้าย เพื่อสนับสนุนการเลือกตัวเลือกนั้น ๆ โดยเฉพาะในส่วนพบว่ามีความเสี่ยงปานกลาง หรือ ความเสี่ยงสูง (มีบางส่วน หรือ ไม่มี) พร้อมทั้งระบุรายละเอียดแผนปฏิบัติงาน (Action Plan) เพื่อลดความเสี่ยงดังกล่าว รวมถึงกำหนดระยะเวลาเป้าหมายที่เหมาะสมเพื่อให้สามารถบรรลุเป้าหมายสู่ความเสี่ยงต่ำได้</li>
                                <li>ภายหลังจากระบุกระบวนการทำงาน/บริการที่ข้อมูลไม่มีคุณภาพข้อมูล (หรือ มีความเสี่ยงสูง) และมีคุณภาพข้อมูลบ้างส่วน (หรือ มีความเสี่ยงปานกลาง) ทีมผู้ประเมินคุณภาพข้อมูลและ/หรือคณะประเมินด้านประสิทธิภาพขององค์กรจะดำเนินการร่วมกับ กอง/สำนัก/ฝ่าย/ศูนย์ ที่ได้ระบุแผนปฏิบัติงาน (Action Plan) เพื่อลดความเสี่ยง โดยการดำเนินงานตามแผนปฎิบัติจะมีการตรวจสอบจากทีมผู้ประเมินคุณภาพข้อมูล/คณะกรรมการตรวจสอบและรับรองอย่างน้อยทุก 6 เดือน</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <fieldset class="form-section">
                        <legend><i data-lucide="book-open"></i> ด้านการพัฒนานโยบายและแนวปฏิด้านข้อมูล</legend>
                            ...
                            <table class="assessment-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">นโยบายและแนวปฏิบัติที่หน่วยงานกำหนดสอดคล้องและเป็นไปตามมาตรฐานและหลักเกณฑ์ที่เกี่ยวข้อง/ที่มีอยู่ทั้งในระดับประเทศ ตลอดจนแนวทางการปฏิบัติในระดับหน่วยงาน/ระดับพื้นที่ หรือไม่</td>
                                        <td class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">มีการนำนโยบาย แนวปฏิบัติ และคำแนะนำด้านคุณภาพข้อมูลไปปฏิบัติอย่างสม่าเสมอและทั่วถึง รวมถึงมีกลไกติดตามการปฏิบัติตามนโยบายและแนวปฏิบัติ รวมถึงการรายงานผลการดาเนินการอย่างเป็นทางการต่อผู้บริหารระดับสูง หรือไม่</td>
                                        <td class="text-center">
                            ...
                            <table class="assessment-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">มีระบบและกระบวนการทำงานเป็นไปตามหลักการที่ถูกต้องตั้งแต่แรกเริ่ม แทนที่การใช้กระบวนการแก้ไข การทำข้อมูลให้มีความสมบูรณ์ (data cleaning) หรือ การจัดการข้อมูลอย่างครอบคลุมเพื่อสร้างข้อมูลที่จำเป็น</td>
                                        <td class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">การเตรียมการในการจัดเก็บ การบันทึก การรวบรวม และการรายงานข้อมูล ได้รวมไว้ในการวางแผนดำเนินการและกระบวนการจัดการเชิงโครงสร้างเพื่อสนับสนุนการทำงานของบุคลากรในแต่ละวัน</td>
                                        <td class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">ระบบสารสนเทศมีการควบคุมภายในเพื่อลดความผิดพลาดที่เกิดจากบุคคล หรือมีจากการจัดการและป้องกันความผิดพลาดที่เกิดจากการป้อนข้อมูล ข้อมูลสูญหาย หรือการเปลี่ยนแปลงข้อมูลที่ไม่ได้รับอนุญาต โดยการควบคุมดังกล่าวได้รับการตรวจสอบอย่างน้อยปีละครั้งเพื่อมั่นใจว่าการทำงานมีประสิทธิภาพ หรือไม่</td>
                                        <td class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">มีข้อกำหนดด้านคุณภาพอย่างเป็นทางการซึ่งถูกนำไปใช้สำหรับผู้ใช้บริการด้านข้อมูลบุคคลที่สาม (3rd party data) ทั้งหมด (ตัวอย่าง เช่น ในรูปแบบ/ฟอร์มของหลักเกณฑ์การแบ่งปันข้อมูล คำชี้แจง หรือข้อตกลงระดับการบริการ เป็นต้น) หรือไม่</td>
                                        <td class="text-center">
                            ...
                            <table class="assessment-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">ข้อมูลที่ถูกใช้เพื่อการรายงานต่อหน่วยงานภายนอกอยู่ภายใต้การตรวจสอบอย่างเข้มงวด และได้รับการอนุมัติจากผู้บริหารระดับสูง หรือไม่</td>
                                        <td class="text-center">
                            ...
                            <table class="assessment-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify font-medium">มีการรวบรวมขอบเขตที่มีความเสี่ยงระดับปานกลาง และระดับสูงไว้ในการบริหารจัดการความเสี่ยงของแผนการให้บริการในปัจจุบันของหน่วยงาน หรือไม่</td>
                                        <td class="text-center">
