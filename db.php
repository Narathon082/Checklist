...
if ($conn->query($createFormFieldsTable)) {
    ...
    if ($checkEmptyFields && $checkEmptyFields->fetch_assoc()['count'] == 0) {
        $defaultFields = [
            ...
            [4, 'G', 'g1', 'มีแผนการดำเนินงานธรรมาภิบาลข้อมูลภายในหน่วยงานและสอดคล้องกับนโยบายกระทรวงพาณิชย์', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 510],
            [4, 'G', 'g2', 'มีการระบุสิทธิ์ หน้าที่ และความรับผิดชอบของบุคลากรต่อข้อมูล (Data Owner, Data Custodian) อย่างชัดเจน', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 520],
            [4, 'G', 'g3', 'มีกระบวนการและมาตรฐานการจัดเก็บข้อมูล การเข้าถึงข้อมูลอย่างเป็นระบบ', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 530],
            [4, 'G', 'g4', 'มีการจัดทำพจนานุกรมข้อมูล (Data Dictionary) และคำอธิบายข้อมูล (Metadata) ที่ชัดเจน', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 540],
            [4, 'G', 'g5', 'มีคณะกรรมการหรือคณะทำงานทำหน้าที่ควบคุมดูแลและรักษาคุณภาพของข้อมูลอย่างสม่ำเสมอ', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 550],
            [4, 'G', 'g6', 'มีการทบทวนกระบวนการบริหารจัดการข้อมูลและการเปิดเผยข้อมูลในรูปแบบ Open Data', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 560],
            [4, 'G', 'g7', 'มีแนวทางปฏิบัติหรือคู่มือการทำงานเกี่ยวกับความปลอดภัยข้อมูลและการควบคุมการเข้าใช้งาน', 'ระบุหลักฐานหรือความเห็น...', 'radio', 1, 570],
